	...
	<div class="r-sub-con">
		...
		<div id="bo_list" style="width:<?php echo $width; ?>">
				...
				<div class="bo_list_head">
						...
						<span class="s-view"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회 <i class="fa fa-sort" aria-hidden="true"></i></a></span>
						...
						<span class="s-day"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>날짜  <i class="fa fa-sort" aria-hidden="true"></i></a></span>
								</li>
						</ul>
				</div>
				<div class="bo_list">
